...
class TelemetryLogger:
    ...
    - alerts.csv: notification delivery records,
    ...
    def __init__(
        ...
        real_bad_posture_min_seconds: float = 0.0,
    ) -> None:
        ...
        self._alerts_writer: csv.DictWriter | None = None
    ...
    def write_session_metadata(self, config_snapshot: Mapping[str, Any], extra: Mapping[str, Any] | None = None) -> None:
        ...
        payload: dict[str, Any] = {
            ...
            "real_bad_posture_min_seconds": self._real_bad_posture_min_seconds,
        }
        if extra:
    ...
    def log_alert(self, row: Mapping[str, Any]) -> None:
        ...
        normalized = self._normalize_row(row, self.ALERT_FIELDNAMES)
        self._alerts_writer.writerow(normalized)
        self._maybe_flush(force=True)
    ...
    def close(self) -> None:
        ...
        for handle in (self._timeline_file, self._events_file, self._alerts_file):
            if handle is None:
                continue
            try:
                handle.flush()
